...
const Dashboard = () => {
  ...
  const handleDialogSubmit = () => {
    // Perform actions with projectName and projectDescription
  ...
  const [projects, setProjects] = useState([
    {
      ...
      status: "Completed",
      collaborators: [
        { name: "John Doe", image: "https://avatar.iran.liara.run/public" },
        { name: "Jane Doe", image: "https://avatar.iran.liara.run/public" },
        { name: "Ricky Doe", image: "https://avatar.iran.liara.run/public" },
        { name: "Micky Doe", image: "https://avatar.iran.liara.run/public" },
      ],
      tasks: [
                  ...
                  <div className="flex items-center space-x-2 mt-2">
                    {project.collaborators.slice(0, 2).map((avatar, index) => (
                      <img
                        ...
                        style={{ zIndex: project.collaborators.length - index }}
                      />
                    ))}
