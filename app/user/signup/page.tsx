        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
              I agree to the <TLink text="Terms and Conditions" href="terms" />
            </label>
          </div>
          <div>
            <TButton text="Sign up" fullWidth={true} />
          </div>
          <div>
            <p className="text-center text-sm text-gray-700">Or sign up with</p>
          </div>
          <div>
            <SocialSignInOptions />
          </div>
          ...
          <div className="flex items-center justify-center">
            <p className="text-center text-sm text-gray-700">
              Already have an account? <TLink text="Sign in" href="./signin" />
            </p>
          </div>
        </form>
      </div>
